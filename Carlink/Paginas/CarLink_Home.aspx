...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class=" d-flex justify-content-center align-items-center p-3">
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 card-deck">
            ...
            <a class="col d-flex justify-content-center my-1 p-0 text-decoration-none" href="CarLink_Dashboard.aspx">
                <div class="card btn-home bg_img ">
            ...
            <a class="col d-flex justify-content-center my-1 p-0 text-decoration-none" href="Carlink_Consultas.aspx">
                <div class="card btn-home bg_img">
                    <div class="card-body d-flex justify-content-center align-items-center">
            ...
            <a class="col d-flex justify-content-center my-1 p-0 text-decoration-none" href="Carlink_Administrar.aspx">
                <div class="card btn-home bg_img">
                    <div class="card-body d-flex justify-content-center align-items-center">
